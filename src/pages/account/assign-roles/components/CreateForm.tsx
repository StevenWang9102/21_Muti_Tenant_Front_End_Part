...
const CreateForm: React.FC<CreateFormProps> = (props) => {
  const { modalVisible, onCancel, onSubmit, fromPage, branchesData, rolesData, setSelectedKeys, setSelectedRowsUserId } = props;
  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Button key="submit" type="primary" onClick={() => assignNewBranchRoles()}>
          Assign
        </Button>,
      ]}
    >
