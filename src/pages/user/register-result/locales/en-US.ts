export default {
  ...
  'userandregister-result.register-result.msg': 'Your account:  {email} successfully registered',
  ...
  'userandregister-result.register-result.go-to-menuhub': 'Go To MenuHub',
};
