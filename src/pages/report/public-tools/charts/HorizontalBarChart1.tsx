...
export const HorizontalBarChart1 = (props) => {
  ...
  console.log('HorizontalBarChart1,sourceData', type, sourceData);
  console.log('HorizontalBarChart1,localSource1', localSource);
