...
interface ListSearchProjectsProps extends FormComponentProps {
  ...
  webposAndListSearchProjects: StateType;
  loading: boolean;
}
...
class ListSearchProjects extends Component<ListSearchProjectsProps> {
  componentDidMount() {
    ...
    dispatch({
      type: 'webposAndListSearchProjects/fetch',
      payload: {
        count: 8,
      },
    });
  ...
  render() {
    const {
      webposAndListSearchProjects: { list = [] },
      loading,
      form,
    } = this.props;
...
export default connect(
  ({
    ...
    webposAndListSearchProjects,
    loading: loading.models.webposAndListSearchProjects,
  }),
)(WarpForm);
