...
class PrintReceipt1 extends Component<PropsInterface, AdvancedState> {
  ...
  render() {
    ...
    console.log('Print8948411,currentInvoice', currentInvoice);
    console.log('Print8948411,oneBranchInfo', oneBranchInfo);
    console.log('Print8948411,currentOrderDetail', currentOrderDetail);
    ...
    return (
      <Card id='PrintThisReceipt' bordered={false} style={{ padding: 5, width: 320, color: 'black' }}>
        ...
        {render && render.map(each => {
          return <section>
            ...
            <Row style={{ margin: '5px 0', color: 'black', width: '100%', textAlign: 'left'}}>
              <Col span={24} style={basicInfoStyle}> {`${each.name.toLowerCase()} ${each.value}`} </Col>
            </Row>}
          </section>
        })}
